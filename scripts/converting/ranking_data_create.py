...
from scripts.utils.novel import load_ranking_csv
from scripts.utils.model import RankingDataMaker
...
if __name__ == '__main__':
    ...
    if mode == 'ncode':
        ...
        ncode_list = [ranking['ncode'] for ranking in load_ranking_csv()]
        print(datetime.datetime.now().isoformat(), 'Ranking Count:', len(ncode_list))

    maker = RankingDataMaker()
